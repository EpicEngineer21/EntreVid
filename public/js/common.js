    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        ...
        <a href="/" id="nav-logo" class="flex items-center gap-2.5 group">
          ...
          <span class="font-display font-bold text-lg tracking-tight bg-gradient-to-r from-white to-brand-300 bg-clip-text text-transparent">EntreVid</span>
        </a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <p class="text-xs text-gray-500">
          &copy; ${year} Online Video Directory for Entrepreneurs.
          Discover founder stories, ideas, and startup insights.
        </p>
